...
<div>
    <a href="https://www.loom.com/share/fe8ae3534c19453aae96e3b8a1e2d565">
    </a>
    <a href="https://www.loom.com/share/fe8ae3534c19453aae96e3b8a1e2d565">
      <img style="max-width:300px;" src="https://cdn.loom.com/sessions/thumbnails/fe8ae3534c19453aae96e3b8a1e2d565-f66cce0bf94ab111-full-play.gif">
    </a>
  </div>
...
Yes, the topics discussed in the labs helped me and prepared me for the assignment. For example, the labs really helped me with debugging code, so when I ran into a problem in my project code, the things I learned from the labs (chrome dev tools) helped me fix my code.

* If you had more time, what would you have done differently? Would you have added additional features? Changed the way your project responded to a particular event, etc.
  
I would have added more dynamic animations to the website, so things changing on the website

* Reflect on your project demo, what went well? Were there things that maybe didn't go as planned? Did you notice something that your peer did that you would like to try next time?

I think that the styling went well, I like how the website looks and I feel like its aesthetically pleasing. I think that sometimes through out the project, I ran into roadblocks that took me time to fix, like using google and AI, but overal I was able to overcome the road blocks that came up.
